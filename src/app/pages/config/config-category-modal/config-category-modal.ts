...
export class ConfigCategoryModal extends Base {
  form: FormGroup;
  title = 'Add';

  types = [
    { code: 'V', label: 'Investment' },
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ConfigCategoryModal>,
    @Inject(MAT_DIALOG_DATA) public data: { category: CategoryResponse, width?: string },
  ) {
    super();
